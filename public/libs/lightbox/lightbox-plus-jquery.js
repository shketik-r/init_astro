...
(function (root, factory) {
  ...
  Lightbox.prototype.start = function ($link) {
    ...
    function addToAlbum($link) {
      self.album.push({
        ...
        download: $link.attr('data-download') || $link.attr('download')
      });
    }
  ...
  Lightbox.prototype.changeImage = function (imageNumber) {
    ...
    this.$lightbox.find('.lb-image, .lb-nav, .lb-prev, .lb-next, .lb-dataContainer, .lb-numbers, .lb-caption', 'lb-download').hide();
  ...
  Lightbox.prototype.updateDetails = function () {
    ...
    if (typeof this.album[this.currentImageIndex].download !== 'undefined' &&
      ...
      if (this.options.showDownload) {
        $download.html('<span>Скачать фото</span>');
      } else {
        $download.html('<span>Скачать фото</span>');
        $download.attr('href', this.album[this.currentImageIndex].download);
      }
